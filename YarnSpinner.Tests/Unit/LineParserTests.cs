...
namespace YarnSpinner.Tests
{
    ...
    public class LineParserTests
    {
        ...
        [Fact]
        public void LineEndsWithBackslash()
        {
            var line = "A [b]B[/b]\\";
            var markup = _lineParser.ParseMarkup(line);
        ...
        public void TestAttributeRemoval() {
            ...
            var originalMarkup = _lineParser.ParseMarkup(line);
        ...
        public void TestMultibyteCharacterParsing(string input) {
            var markup = _lineParser.ParseMarkup(input);
        ...
        public void TestCharacterAttributeParsing(string input) {
            var markup = _lineParser.ParseMarkup(input);
